package com.library.reactivelocation.sample;
...
import com.library.reactivelocation.library.ReactiveLocationProvider;
import com.library.reactivelocation.library.ReactiveLocationProviderConfiguration;
import com.library.reactivelocation.sample.utils.AddressToStringFunc;
import com.library.reactivelocation.sample.utils.DetectedActivityToString;
import com.library.reactivelocation.sample.utils.DisplayTextOnViewAction;
import com.library.reactivelocation.sample.utils.LocationToStringFunc;
import com.library.reactivelocation.sample.utils.ToMostProbableActivity;

import static com.library.reactivelocation.sample.utils.UnsubscribeIfPresent.dispose;
...
public class HomeActivity extends BaseActivity {
                    ...
                    public void accept(LocationSettingsResult locationSettingsResult) {
                        ...
                        if (status.getStatusCode() == LocationSettingsStatusCodes.RESOLUTION_REQUIRED) {
                            try {
                                ...
                                Log.e("HomeActivity", "Error opening settings activity.", th);
                            }
                        }
                    }
                })
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add("Places").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (TextUtils.isEmpty(getString(R.string.API_KEY))) {
                    Toast.makeText(HomeActivity.this, "First you need to configure your API Key - see README.md", Toast.LENGTH_SHORT).show();
                } else {
        ...
        menu.add("Mock Locations").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                startActivity(new Intent(HomeActivity.this, MockLocationsActivity.class));
                return true;
            }
        });
        return true;
    ...
    private class ErrorHandler implements Consumer<Throwable> {
        ...
        public void accept(Throwable throwable) {
            ...
            Log.d("HomeActivity", "Error occurred", throwable);
        }
    }
