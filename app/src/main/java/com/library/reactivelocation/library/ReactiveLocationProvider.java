package com.library.reactivelocation.library;
...
import com.library.reactivelocation.library.observables.GoogleAPIClientObservableOnSubscribe;
...
import com.library.reactivelocation.library.observables.PendingResultObservableOnSubscribe;
import com.library.reactivelocation.library.observables.activity.ActivityUpdatesObservableOnSubscribe;
import com.library.reactivelocation.library.observables.geocode.GeocodeObservable;
import com.library.reactivelocation.library.observables.geocode.ReverseGeocodeObservable;
import com.library.reactivelocation.library.observables.geofence.AddGeofenceObservableOnSubscribe;
import com.library.reactivelocation.library.observables.geofence.RemoveGeofenceObservableOnSubscribe;
import com.library.reactivelocation.library.observables.location.AddLocationIntentUpdatesObservableOnSubscribe;
import com.library.reactivelocation.library.observables.location.LastKnownLocationObservableOnSubscribe;
import com.library.reactivelocation.library.observables.location.LocationUpdatesObservableOnSubscribe;
import com.library.reactivelocation.library.observables.location.MockLocationObservableOnSubscribe;
import com.library.reactivelocation.library.observables.location.RemoveLocationIntentUpdatesObservableOnSubscribe;
...
public class ReactiveLocationProvider {
     ...
     * @see GoogleApiClient.Builder#setHandler(Handler)
     ...
     * any value.
     * <p/>
     * Observable can report {@link com.library.reactivelocation.library.observables.GoogleAPIConnectionException}
     ...
     * must hold the android.permission.ACCESS_MOCK_LOCATION permission, or a {@link SecurityException}
     * will be thrown.
     * <p/>
     * All statuses that are not successful will be reported as {@link com.library.reactivelocation.library.observables.StatusException}.
     * <p/>
     * Every exception is delivered by {@link io.reactivex.Observer#onError(Throwable)}.
     *
     * @param sourceLocationObservable observable that emits {@link Location} instances suitable to use as mock locations
     * @return observable that emits {@link Status}
     */
    @RequiresPermission(
    ...
    /**
     * Creates an observable that adds a {@link PendingIntent} as a location listener.
     * <p/>
     * This invokes {@link com.google.android.gms.location.FusedLocationProviderApi#requestLocationUpdates(GoogleApiClient, LocationRequest, PendingIntent)}.
     * <p/>
     * When location updates are no longer required, a call to {@link #removeLocationUpdates(PendingIntent)}
     * should be made.
     * <p/>
     * In case of unsuccessful status {@link com.library.reactivelocation.library.observables.StatusException} is delivered.
     *
     * @param locationRequest request object with info about what kind of location you need
    ...
    /**
     * Observable that can be used to remove {@link PendingIntent} location updates.
     * <p/>
     * In case of unsuccessful status {@link com.library.reactivelocation.library.observables.StatusException} is delivered.
     *
     ...
     * In case of unsuccessful status {@link com.library.reactivelocation.library.observables.StatusException} is delivered.
     * <p/>
     * Other exceptions will be reported that can be thrown on {@link com.google.android.gms.location.GeofencingApi#addGeofences(GoogleApiClient, GeofencingRequest, PendingIntent)}
     *
     ...
     * In case of unsuccessful status {@link com.library.reactivelocation.library.observables.StatusException} is delivered.
     * <p/>
     * Other exceptions will be reported that can be thrown on {@link com.google.android.gms.location.GeofencingApi#removeGeofences(GoogleApiClient, PendingIntent)}.
     * <p/>
     * Every exception is delivered by {@link io.reactivex.Observer#onError(Throwable)}.
     *
     ...
     * In case of unsuccessful status {@link com.library.reactivelocation.library.observables.StatusException} is delivered.
     * <p/>
     * Other exceptions will be reported that can be thrown on {@link com.google.android.gms.location.GeofencingApi#removeGeofences(GoogleApiClient, List)}.
     * <p/>
     * Every exception is delivered by {@link io.reactivex.Observer#onError(Throwable)}.
     *
     ...
     * {@link AutocompletePredictionBuffer} you can use
     * {@link DataBufferObservable}.
     *
     ...
     * In case of error {@link com.library.reactivelocation.library.observables.GoogleAPIConnectionException} is emmited.
     * When connection to Google Play Services is suspended {@link com.library.reactivelocation.library.observables.GoogleAPIConnectionSuspendedException}
     * is emitted as error.
